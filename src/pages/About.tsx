...
import { Award, Brain, Microscope, ChevronLeft } from 'lucide-react';
            ...
            <main className="max-w-4xl mx-auto px-6 py-12">
                <section className="mb-20 text-center md:text-left flex flex-col md:flex-row items-center gap-12">
                    <div className="flex-1">
                        ...
                        <p className="text-xl text-slate-600 leading-relaxed mt-4">  
                            Please contact me via email at luischanchess@gmail.com or text me at +61 435 808 836 if you have any questions about my coaching or want to book a session!
                        </p>
                    </div>
                ...
                <section className="grid md:grid-cols-3 gap-8 mb-20">
                    <div className="p-8 bg-slate-50 rounded-2xl border border-slate-100">
                        ...
                        <p className="text-sm text-slate-600">Reaching 2300 FIDE requires more than talent—it requires a system. I teach you that system.</p>
                    </div>
                    <div className="p-8 bg-slate-50 rounded-2xl border border-slate-100">
                        <Microscope className="text-indigo-600 mb-4" size={32} />
                        <h3 className="font-bold text-lg mb-2">Analytical Rigor</h3>
                        <p className="text-sm text-slate-600">We don't just "guess" at moves. We use data-driven engine analysis to find your true weaknesses.</p>
                    </div>
                    <div className="p-8 bg-slate-50 rounded-2xl border border-slate-100">
                        <Brain className="text-indigo-600 mb-4" size={32} />
                        <h3 className="font-bold text-lg mb-2">Psychology</h3>
                        <p className="text-sm text-slate-600">I specialize in building opening repertoires that match your unique competitive temperament.</p>
                    </div>
                </section>
                ...
                <section className="prose prose-slate lg:prose-xl">
                    ...
                    <p className="mb-4">
                        Chess is often taught as a series of patterns to memorise. But at the Master level,
                        chess is about <strong>efficiency</strong>.
                    </p>
                    <p className="mb-4">
                ...
                <footer className="mt-20 p-12 bg-indigo-600 rounded-3xl text-white text-center">
                    <h2 className="text-3xl font-bold mb-4">Ready to optimize your game?</h2>
