...
import logo from '../assets/Chess Parfait AI Logo.png'; // Adjusted path for pages folder
            ...
            <nav className="py-2 px-6 flex justify-between items-start bg-white shadow-sm border-b border-slate-100">
                ...
                >
                    <img
                        ...
                        className="h-24 w-auto md:h-32 -mt-2"
                    />
                    {/* The Slogan */}
                    <span className="text-l md:text-xl font-medium tracking-widest text-slate-500 -mt-2 group-hover:text-indigo-600 transition-colors"
                        style={{ fontFamily: "'Dancing Script', cursive" }}>
                        Perfect Your Chess
                    </span>
                </Link>
                <div className="flex items-center gap-6 mt-4">
                    <Link to="/Challenge_Rulette" className="text-slate-600 font-semibold hover:text-indigo-600 transition">
                        Challenge Rulette
                    </Link>
                </div>
                <div className="flex items-center gap-6 mt-4">
                    <Link to="/about" className="bg-indigo-600 text-white px-6 py-2 rounded-full font-bold hover:bg-indigo-700 shadow-md transition">
                        About Me
                    </Link>
                </div>
            </nav>
